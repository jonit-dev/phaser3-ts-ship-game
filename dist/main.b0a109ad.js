...
function (_super) {
  ...
  LoadScene.prototype.loadImages = function () {
    ...
    for (var prop in CST_1.CST.IMAGE) {
      console.log("trying to load " + CST_1.CST.IMAGE[prop]);
  ...
  LoadScene.prototype.preload = function () {
    // ASSET LOADING ========================================
    var _this = this; //load out sprite atlas


    this.load.atlas("characters", "./assets/sprite/characters.png", "./assets/sprite/characters.json");
    this.load.atlas("daze", "./assets/sprite/daze.png", "./assets/sprite/daze.json"); // this.loadAudio();
...
},{"../CST":"src/CST.ts"}],"src/utils/ButtonHelper.ts":[function(require,module,exports) {
"use strict";
...
var setButtonInteractivity = function setButtonInteractivity(button, hoverSprite) {
  button.setInteractive();
  button.on("pointerover", function () {
    console.log("hovaaa");
    hoverSprite.setVisible(true);
    hoverSprite.play("walk"); //place it to the left of the button
...
exports.default = {
  setButtonInteractivity: setButtonInteractivity
};
...
exports.default = Mandy;
},{"./Character":"src/resources/characters/Character.ts"}],"node_modules/underscore/underscore.js":[function(require,module,exports) {
...
var Character_1 = __importDefault(require("../resources/characters/Character"));

var Mandy_1 = __importDefault(require("../resources/characters/Mandy"));
...
var ButtonHelper_1 = __importDefault(require("../utils/ButtonHelper"));
...
function (_super) {
  ...
  MenuScene.prototype.create = function () {
    ...
    var _a = this.game.renderer,
        width = _a.width,
        height = _a.height; //add image background

    this.add.image(0, 0, CST_1.CST.IMAGE.TITLE).setOrigin(0, 0).setDepth(0); // play our background music
    ...
    this.add.image(width / 2, height * 0.2, CST_1.CST.IMAGE.LOGO) // .setScale(0.3)
    .setDepth(1); //play button

    var playButton = this.add.image(width / 2, height / 2, CST_1.CST.IMAGE.PLAY); //options button

    var optionsButton = this.add.image(width / 2, height / 2 + 100, CST_1.CST.IMAGE.OPTIONS); // CAT ========================================

    var hoverSprite = this.add.sprite(100, 100, CST_1.CST.SPRITE.CAT).setScale(2);
    hoverSprite.setVisible(false); // add some animation to it =)
    ...
    *##############################################################*/
    ...
    ButtonHelper_1.default.setButtonInteractivity(playButton, hoverSprite);
    ButtonHelper_1.default.setButtonInteractivity(optionsButton, hoverSprite);
    playButton.on("pointerup", function () {
      _this.scene.start(CST_1.CST.SCENES.PLAY, PlayScene_1.PlayScene);
    });
  };
...
},{"../CST":"src/CST.ts","../utils/ButtonHelper":"src/utils/ButtonHelper.ts","./PlayScene":"src/scenes/PlayScene.ts"}],"src/main.ts":[function(require,module,exports) {
"use strict";
